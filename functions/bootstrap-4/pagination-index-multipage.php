...
if ( ! function_exists( 'progenitor_pagination' ) ) {
	function progenitor_pagination() {
		global $wp_query;
		...
		$paginate_links = paginate_links( array(
			...
			'mid_size' => 5,
			'prev_next' => True,
			'prev_text' => __('<i class="fas fa-angle-left"></i> Newer', 'progenitor'),
			'next_text' => __('Older <i class="fas fa-angle-right"></i>', 'progenitor'),
			'type' => 'list'
		) );
